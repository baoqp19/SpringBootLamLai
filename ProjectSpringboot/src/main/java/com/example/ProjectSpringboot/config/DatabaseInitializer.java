...
import com.example.ProjectSpringboot.repository.PermissionRepository;
import com.example.ProjectSpringboot.repository.RoleRepository;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // chưa có ai thì nó tự tạo ra admin và Role 
        if (countRoles == 0) {
